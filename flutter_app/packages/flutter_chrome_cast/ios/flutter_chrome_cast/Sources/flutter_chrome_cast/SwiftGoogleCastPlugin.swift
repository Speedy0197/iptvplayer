...
public class SwiftGoogleCastPlugin: NSObject, GCKLoggerDelegate, FlutterPlugin, UIApplicationDelegate {
  ...
  public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
    ...
    /// - Reusing the process context when the authenticated Dart scope changes
    ///
    /// - Parameters:
    ...
    private func setSharedInstanceWithOption(arguments: Dictionary<String, Any> ,result: @escaping FlutterResult){
        ...
        // The process-wide SDK singleton outlives authenticated Dart scopes.
        ...
        // Initialization does not scan or alter an existing receiver session.
        result(true)
